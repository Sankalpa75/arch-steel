...
if (!in_array($page, array('home', 'about', 'new-design', 'mechanical-work', 'fabrication', 'prefab-work', 'bridge', 'steel-structure', 'gallery', 'supervision', 'contact', 'quote_send', 'contact_send', 'submit','civil-work','fencing-work'))) {
    ...
    <title>
        ...
        switch ($page) {
            ...
            case 'home':
                ...
                echo "ARCH STEEL ENGINEERING SERVICES";
    ...
    <div class="top-header">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <p>
                        <span> <i class="fa fa-map-marker"></i> Tathali-9, Bhaktapur </span>
                        <a href="mailto:archsteel567@gmail.com"><i class="fa fa-envelope"></i> archsteel567@gmail.com</a>
        ...
        <div class="header">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <a href="tel:+9779851167795" style="text-decoration:none;">
                            ...
                            <ul class="main-menu clearfix">
                                ...
                                <li><a href="#">Services <span class="drop-icon">▾</span> <label title="Toggle Drop-down" class="drop-icon" for="sm1">▾</label></a>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="./steel-structure">Steel Structure</a></li>
                                        <li><a href="./prefab-work">Prefab Works</a></li>
                                        <li><a href="./mechanical-work">Mechanical Work</a></li>
                                        <li><a href="./fabrication">Fabrication Works</a></li>
                                        <li><a href="./supervision">Supervision</a></li>
                                        <li><a href="./bridge">Bridge Works</a></li>
                                        <li><a href="./civil-work">Civil Work</a></li>
                                        <li><a href="./fencing-work">Fencing Works</a></li>
                    ...
                    <div class="col-sm-4">
                        <p>
                            <a href="https://www.facebook.com/ARCH-STEEL-Engineering-Services-811845958963487/?epa=SEARCH_BOX"> <i class="fa fa-facebook"></i> </a>
