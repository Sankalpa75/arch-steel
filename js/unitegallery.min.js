...
function UGThumbsGeneral() {
  function e(e, t, i, n) {
    ...
    i
      ? (n !== !0 && i.css(r), i.children(a).css(o))
      : (w.children(".ug-thumb-wrapper").css(r), w.find(a).css(o));
  }
  function t(e, t, i, n) {
    if (!n) var n = !1;
    ...
    (o["border-width"] = t + "px"),
      ...
      n && n === !0
        ...
        : (0 == t
            ? r.stop().fadeOut(x.thumb_transition_duration)
  ...
  function r(e, r) {
    if (
      (j.isEffectBorder &&
        t(e, x.thumb_selected_border_width, x.thumb_selected_border_color, r),
      j.isEffectOverlay)
    ) {
  ...
  function o(e) {
    ...
    return (
      ...
      1 == j.customThumbs
        ? (T.trigger(E.events.IMAGELOADERROR, e), !0)
  ...
  function a() {
    ...
    w.find(".ug-thumb-wrapper, .ug-thumb-wrapper .ug-thumb-border-overlay").css(
      e
    );
  }
  function s(e, t) {
  ...
  function u(t, i, n) {
    if (1 == x.thumb_fixed_size) P.scaleImageCoverParent(i, t);
      ...
      "height" == x.thumb_resize_by
        ? P.scaleImageByHeight(i, x.thumb_height)
        : P.scaleImageByWidth(i, x.thumb_width);
      var r = P.getElementSize(i);
      P.placeElement(i, 0, 0), e(r.width, r.height, t);
    }
    t.children(".ug-thumb-loader").hide(),
      i.show(),
      0 == x.thumb_image_overlay_effect
        ? i.fadeTo(0, 1)
        : (1 == x.thumb_image_overlay_effect && d(i), i.fadeTo(0, 0), l(t)),
      T.trigger(E.events.AFTERPLACEIMAGE, t);
  }
  function d(e) {
  ...
  function h(e) {
    return 1 == j.touchEnabled
      ...
      : void (0 == g(e) && E.setThumbOverStyle(e));
  }
  function p(e) {
    return 1 == j.touchEnabled
      ? !0
      : void (0 == g(e) && E.setThumbNormalStyle(e, !1));
  }
  function f(e, t) {
    if (!t) var t = !1;
    var i = jQuery(e),
    ...
    return 0 == n.parent().length
      ? !1
      : ((objItem = E.getItemByThumb(n)),
        1 == objItem.isLoaded && t === !1
          ? !1
          : (E.triggerImageLoadedEvent(n, i),
            void (1 == j.customThumbs
              ? T.trigger(E.events.PLACEIMAGE, [n, i])
              : u(n, i, objItem))));
  }
  function m(e, t, i) {
    (objItem = E.getItemByThumb(t)),
      (objItem.isLoaded = !0),
  ...
  (this.init = function (e, t) {
    (b = e.getObjects()),
      ...
      (I = b.g_arrItems),
      (x = jQuery.extend(x, t)),
      (j.isEffectBorder = x.thumb_border_effect),
      (j.isEffectOverlay = x.thumb_color_overlay_effect),
      (j.isEffectImage = x.thumb_image_overlay_effect);
  }),
      ...
      for (var n = 0; t > n; n++) {
        ...
        if (0 == j.customThumbs) {
          if (1 == x.thumb_show_loader && c) {
            ...
            "bright" == x.thumb_loader_type && (h = "ug-thumb-loader-bright"),
              g.append("<div class='ug-thumb-loader " + h + "'></div>"),
              g.append(
          ...
          if (c) {
            if (
              (c.addClass("ug-thumb-image"), 1 == x.thumb_image_overlay_effect)
            ) {
              var p = c.clone().appendTo(g);
              p
                .addClass("ug-thumb-image-overlay " + i)
        ...
        j.isEffectBorder &&
          g.append("<div class='ug-thumb-border-overlay'></div>"),
          j.isEffectOverlay && g.append("<div class='ug-thumb-overlay'></div>"),
          w.append(g),
          j.customThumbs && j.funcSetCustomThumbHtml(g, r),
          (I[n].objThumbWrapper = g);
      }
    }),
    (this.setThumbNormalStyle = function (e, r, o) {
      if (
        (1 == j.customThumbs && e.removeClass("ug-thumb-over"),
        j.isEffectBorder && t(e, x.thumb_border_width, x.thumb_border_color, r),
        j.isEffectOverlay)
      ) {
    ...
    (this.setThumbOverStyle = function (e) {
      if (
        ...
        j.isEffectBorder &&
          t(e, x.thumb_over_border_width, x.thumb_over_border_color),
        j.isEffectOverlay)
      ) {
    ...
    (this.setHtmlProperties = function () {
      ...
      if (
        (w.children(".ug-thumb-wrapper").each(function () {
          var e = jQuery(this);
          l(e);
        }),
    ...
    (this.setThumbSelected = function (e) {
      return (
        1 == j.customThumbs && e.removeClass("ug-thumb-over"),
        1 == g(e) ? !0 : (e.addClass("ug-thumb-selected"), void r(e))
      );
    }),
    (this.setThumbUnselected = function (e) {
      e.removeClass("ug-thumb-selected"),
        E.setThumbNormalStyle(e, !1, "set unselected");
    }),
    ...
    (this.initEvents = function () {
      ...
      e.on("touchstart", function () {
        ...
        1 == j.allowOnResize && y.on(C.eventSizeChange, c),
        e.hover(
          function (e) {
            var t = jQuery(this);
            h(t);
    ...
    (this.destroy = function () {
      var e = w.find(".ug-thumb-wrapper");
      e.off("touchstart"),
        y.off(C.eventSizeChange),
        e.off("mouseenter"),
        e.off("mouseleave"),
        T.off(E.events.THUMB_IMAGE_LOADED);
    }),
...
function UGThumbsStrip() {
  ...
  function f() {
    return I()
      ? !1
      : void (0 == N
          ? H.placeElement(C, k.strip_thumbs_align, 0)
          : H.placeElement(C, 0, k.strip_thumbs_align));
  }
  function m(e) {
  ...
  function y() {
    ...
    e.on("click touchend", function (e) {
      ...
      R.isNotFixedThumbs && jQuery(L).on(L.events.AFTERPLACEIMAGE, v);
  }
  function I() {
  ...
  (this.setHtml = function (e) {
    ...
    e.append(
      ...
      L.setHtmlThumbs(C),
      1 == R.isNotFixedThumbs && L.hideThumbs();
  }),
    (this.destroy = function () {
      var e = j.find(".ug-thumb-wrapper");
      e.off("click"),
        ...
        jQuery(L).off(L.events.AFTERPLACEIMAGE),
        M && M.destroy(),
        A && A.destroy(),
        L.destroy();
    }),
...
function UGGridPanel() {
  ...
  function s() {
    ...
    var n = j.getElementSize(E),
      r = n.width;
    return (
      (e += 2 * (r + M.gridpanel_arrows_padding_hor)), (t = H.panelWidth - e)
    );
  }
  function l() {
    var e = !1;
    ...
    1 == e
      ? (E.show().fadeTo(0, 1), T.show().fadeTo(0, 1), (H.arrowsVisible = !0))
      : (E.hide(), T.hide(), (H.arrowsVisible = !1));
  }
  function u() {
    var e = C.getSize();
    1 == H.isHorType
      ...
      j.setElementSize(w, H.panelWidth, H.panelHeight);
  }
  function d() {
    return 1 == H.isEventsInited
      ? !1
      : ((H.isEventsInited = !0),
  ...
  function p() {
    ...
    switch (M.gridpanel_grid_align) {
      case "middle":
        switch (M.gridpanel_arrows_align_vert) {
          ...
          case "borders":
            var l =
              H.panelHeight - r.height - M.gridpanel_padding_border_bottom;
            a = (l - o.height) / 2;
        }
        break;
      case "bottom":
    ...
    switch (M.gridpanel_arrows_align_vert) {
      ...
      case "center":
      case "middle":
        (e = o.bottom + (H.panelHeight - o.bottom - r.height) / 2), (i = 0);
        break;
      case "grid":
  ...
  function y() {
    0 == H.isHorType ? (1 == M.gridpanel_vertical_scroll ? h() : f()) : b(),
      A.placeElements();
  }
  var I,
    w,
...
function UGThumbsGrid() {
  ...
  function t(e) {
    ...
    e && (t = e),
      ...
      (Q = G.children(".ug-thumbs-grid-inner")),
      1 == X.isTilesMode ? U.setHtml(Q) : Y.setHtmlThumbs(Q);
  }
  function n() {
    if (0 == X.isHorizontal) {
  ...
  function r() {
    ...
    null != e && d(e.index),
      W.trigger(D.events.PANE_CHANGE, X.currentPane),
      (X.isFirstTimeRun = !1);
  }
  function o() {
  ...
  function s() {
    var e = o(),
      ...
      n =
        ...
        2 * V.grid_padding;
    (X.gridHeight = n),
      B.setElementSize(G, i, n),
      B.setElementSize(Q, i, n),
      (X.innerWidth = i),
      (X.innerHeight = n);
  }
  function l() {
  ...
  function O(e) {
    ...
    var i = E(),
      ...
      r = n > 0 ? "prev" : "next";
    "next" == r
      ? 0 == V.grid_carousel && D.isLastPane()
        ? y()
        : D.nextPane()
      : 0 == V.grid_carousel && D.isFirstPane()
      ? y()
      : D.prevPane();
  }
  function z() {
  ...
  (this.destroy = function () {
    ...
    (this.prevPane = function () {
      ...
      return 0 > e && ((e = X.numPanes - 1), 0 == V.grid_carousel)
        ? !1
        : void D.gotoPane(e, "prev");
    }),
    (this.attachNextPaneButton = function (e) {
      return (
        B.setButtonOnClick(e, D.nextPane),
        1 == V.grid_carousel
          ? !0
          : (D.isLastPane() && e.addClass("ug-button-disabled"),
            void W.on(D.events.PANE_CHANGE, function () {
              D.isLastPane()
    ...
    (this.attachPrevPaneButton = function (e) {
      return (
        B.setButtonOnClick(e, D.prevPane),
        1 == V.grid_carousel
          ? !0
          : (D.isFirstPane() && e.addClass("ug-button-disabled"),
            void W.on(D.events.PANE_CHANGE, function () {
              D.isFirstPane()
                ? e.addClass("ug-button-disabled")
                : e.removeClass("ug-button-disabled");
...
function UGTiles() {
  function e(e, i) {
    (g_objects = e.getObjects()),
      (re = e),
      (q = jQuery(e)),
      (K = g_objects.g_objWrapper),
      ($ = g_objects.g_arrItems),
      (ue = jQuery.extend(ue, i)),
      t(),
      ae.init(e, ue),
      (se = ae.getObjThumbs());
  }
  function t() {
    ue.tiles_min_columns < 1 && (ue.tiles_min_columns = 1),
      0 != ue.tiles_max_columns &&
        ue.tiles_max_columns < ue.tiles_min_columns &&
        (ue.tiles_max_columns = ue.tiles_min_columns);
  }
  function i(e) {
    if (!e) var e = K;
  ...
  function s() {
    1 == de.isTransActive
      ? (setTimeout(function () {
        ...
        de.handle && clearTimeout(de.handle),
        (de.handle = setTimeout(function () {
          a(), ae.triggerSizeChangeEventAllTiles(), (de.handle = null);
        }, 2e3)))
      : (ae.triggerSizeChangeEventAllTiles(), a());
  }
  function l() {
    (le.colWidth = (le.availWidth - le.colGap * (le.numCols - 1)) / le.numCols),
      (le.colWidth = Math.floor(le.colWidth)),
      (le.totalWidth = oe.getSpaceByNumItems(
        le.numCols,
        le.colWidth,
        le.colGap
      ));
  ...
  function u() {
    if (
      ((le.colWidth = ue.tiles_col_width),
      (le.minCols = ue.tiles_min_columns),
      (le.maxCols = ue.tiles_max_columns),
      0 == re.isMobileMode()
        ? (le.colGap = ue.tiles_space_between_cols)
        : (le.colGap = ue.tiles_space_between_cols_mobile),
      (le.galleryWidth = r()),
      (le.availWidth = le.galleryWidth),
      1 == ue.tiles_include_padding &&
        (le.availWidth = le.galleryWidth - 2 * le.colGap),
      1 == ue.tiles_exact_width)
    )
      (le.numCols = oe.getNumItemsInSpace(
        le.availWidth,
        le.colWidth,
        le.colGap
      )),
        le.maxCols > 0 && le.numCols > le.maxCols && (le.numCols = le.maxCols),
        le.numCols < le.minCols
          ? ((le.numCols = le.minCols), l())
          : (le.totalWidth =
              le.numCols * (le.colWidth + le.colGap) - le.colGap);
    else {
      var e = oe.getNumItemsInSpaceRound(le.availWidth, le.colWidth, le.colGap);
      e < le.minCols
        ? (e = le.minCols)
        : 0 != le.maxCols && e > le.maxCols && (e = le.maxCols),
        (le.numCols = e),
        l();
    }
    ...
    for (
      le.maxColHeight = 0, le.arrPosx = [], col = 0;
      col < le.numCols;
      col++
    ) {
  ...
  function _(e, t, i, n) {
    ...
    var l = r + o;
    (le.colHeights[n] = l + le.colGap),
      le.maxColHeight < l && (le.maxColHeight = l),
      1 == t && e.show().fadeTo(0, 1),
      1 == i && J.height(le.maxColHeight);
  }
  function g(e) {
    e || (e = !1), u();
    var t = se.getThumbs();
    ...
    for (var i = 0; i < t.length; i++) {
      var n = jQuery(t[i]),
        r = void 0;
      1 == ue.tiles_keep_order && (r = oe.getColByIndex(le.numCols, i)),
        _(n, e, !1, r);
    }
    s();
    var a = J.height();
    1 == de.isTransActive && a > le.maxColHeight
      ? setTimeout(function () {
  ...
  function p(e, t) {
    ...
    se.triggerImageLoadedEvent(i, e),
      1 == ue.tiles_keep_order
        ? h(i)
        : (ae.resizeTile(i, le.colWidth), _(i, !0, !0));
  }
  function f() {
    var e = se.getThumbs();
    u();
    ...
    if (
      1 == ue.tiles_set_initial_height &&
      0 == oe.isScrollbarExists() &&
      25 > t
    ) {
      var i = (e.length, Math.ceil(e.length / le.numCols)),
        r = i * ue.tiles_col_width * 0.75;
      J.height(r), u();
    }
    e.fadeTo(0, 0);
    var o = jQuery(J).find("img.ug-thumb-image");
    if (1 == de.isFixedMode)
      ne.trigger(ie.events.TILES_FIRST_PLACED),
        g(!0),
    ...
    jQuery.each(i.arrRows, function (t, n) {
      ...
      jQuery.each(n, function (t, n) {
        var u = jQuery(n),
          d = o,
          _ = r[t];
        ae.resizeTile(u, _, d, ae.resizemode.VISIBLE_ELEMENTS),
          oe.placeElement(u, s, a),
          (s += _),
          s > l && (l = s),
          (s += i.gap),
          1 == e && jQuery(n).show();
  ...
  function I() {
    ...
    (_e.galleryWidth = e),
      (ee = {}),
      (_e.colWidth = ue.tiles_nested_col_width),
      (_e.optimalTileWidth = ue.tiles_nested_optimal_tile_width),
      (_e.currentGap = ue.tiles_space_between_cols),
      1 == re.isMobileMode() &&
        (_e.currentGap = ue.tiles_space_between_cols_mobile),
      null == _e.colWidth
        ? (_e.colWidth = Math.floor(_e.optimalTileWidth / _e.nestedOptimalCols))
        : _e.optimalTileWidth > _e.colWidth
        ? (_e.nestedOptimalCols = Math.ceil(_e.optimalTileWidth / _e.colWidth))
        : (_e.nestedOptimalCols = 1),
      (_e.maxColumns = oe.getNumItemsInSpace(e, _e.colWidth, _e.currentGap)),
      (_e.colWidth = oe.getItemSizeInSpace(e, _e.maxColumns, _e.currentGap)),
      (_e.gridY = 0),
      (te = []),
      trace(_e);
    var t = se.getThumbs();
    switch (
      ...
      _e.optimalTileWidth > _e.colWidth
        ...
        : (_e.nestedOptimalCols = 1),
      (_e.totalWidth =
        _e.maxColumns * (_e.colWidth + _e.currentGap) - _e.currentGap),
      ue.tiles_align)
    ) {
      case "center":
      default:
  ...
  function E(e) {
    var t,
      ...
      s = e.index(),
      l = Math.ceil(
        T(s) * ((1 * _e.nestedOptimalCols) / 3) + (2 * _e.nestedOptimalCols) / 3
      ),
      u = a.width,
      d = a.height,
      _ = u / d;
  ...
  function j(e, t, i) {
    ...
    if (
      _e.columnsValueToEnableHeightResize <= l[0] &&
      _e.maxColumns >= 2 * _e.nestedOptimalCols
    ) {
      var u = H(i, n),
        d = L(e, u.newHeight, !0);
      ...
      var _ = O(l, d.dimWidth, i),
        ...
        c = !1;
      g >= 2 && (c = !0),
        u.newHeight >= n.dimHeight && (n = L(e, u.newHeight, !0));
  ...
  function C(e) {
    for (var t = 0, i = 0, n = 0; n < e.length - 1; n++) {
      var r = e[n].sizes,
        ...
        a = -1;
      Q(r.top + r.dimHeight) &&
        _e.maxColumns > r.left + r.dimWidth &&
        ((o = ee[r.top + r.dimHeight - 1][r.left + r.dimWidth]),
        (a = ee[r.top + r.dimHeight][r.left + r.dimWidth])),
        o != a && t++;
    }
    for (var n = 0; n < e.length - 1; n++) {
      ...
      Q(r.top + r.dimHeight) &&
        r.left - 1 >= 0 &&
        ((o = ee[r.top + r.dimHeight - 1][r.left - 1]),
        (a = ee[r.top + r.dimHeight][r.left - 1])),
        o != a && i++;
    }
    return Math.max(i, t);
  }
  function A(e, t, i) {
    var n = te[e],
      ...
      a = n.top,
      s =
        (parseInt(a / (_e.colWidth + _e.currentGap)),
        parseInt(o / (_e.colWidth + _e.currentGap)),
        r - t + i),
      l = L(e, s, !0),
      u = [];
  ...
  function z(e, t, i) {
    ...
    if ((s.push(e), n >= 0)) {
      for (o = 0; n >= 0; ) {
        if (
          ((r = ee[n][i]),
          ("undefined" != typeof ee[n][i - 1] && ee[n][i - 1] == ee[n][i]) ||
            ("undefined" != typeof ee[n][i + t] &&
              ee[n][i + t - 1] == ee[n][i + t]) ||
            ee[n][i] != ee[n][i + t - 1])
        )
  ...
  function H(e, t) {
    ...
    if (
      "undefined" == typeof l[_e.gridY] ||
      "undefined" == typeof l[_e.gridY][e - 1]
    )
      n = 0;
    else
      for (var u = 0; ; ) {
        if (
          "undefined" == typeof ee[_e.gridY + u] ||
          -1 == ee[_e.gridY + u][e - 1]
        )
          break;
    ...
    if (
      "undefined" == typeof l[_e.gridY] ||
      "undefined" == typeof l[_e.gridY][e + r]
    )
      i = 0;
    else
      for (u = 0; ; ) {
  ...
  function G(e) {
    var t = e,
      i = 0;
    if (1 == Q(_e.gridY)) for (; 0 == F(_e.gridY, t); ) i++, t++;
  ...
  function U(e, t) {
    ...
    ae.resizeTile(i, n.width, n.height, ae.resizemode.VISIBLE_ELEMENTS),
      oe.placeElement(i, o, r),
      r + n.height > _e.maxColHeight && (_e.maxColHeight = r + n.height),
      1 == t && i.fadeTo(0, 1);
  }
  function V() {
  ...
  function Z() {
    switch (
      (K.children(".ug-tile").show(),
      1 == de.isFirstTimeRun && X(),
      ae.run(),
      ue.tiles_type)
    ) {
      default:
...
function UGTileDesign() {
  function e(e, i) {
    ...
    (F = jQuery.extend(F, s)),
      ...
      F.tile_size_by == R.sizeby.GLOBAL_RATIO &&
  ...
  function t() {
    if (
      ...
      (Y.isSaparateIcons = !D.isRgbaSupported()),
  ...
  function n(e, t) {
    ...
    (r = D.htmlentitles(r)),
      (i += "<img src='" + t.urlThumb + "' alt='" + r + "' class='" + n + "'>"),
      1 == Y.hasImageContainer && (i += "</div>"),
      e.append(i),
      F.tile_size_by == R.sizeby.GLOBAL_RATIO && e.fadeTo(0, 0);
    var o = {};
    if (
      (1 == F.tile_enable_background &&
        (o["background-color"] = F.tile_background_color),
      1 == F.tile_enable_border &&
        ((o["border-width"] = F.tile_border_width + "px"),
        (o["border-style"] = "solid"),
        (o["border-color"] = F.tile_border_color),
        F.tile_border_radius &&
          (o["border-radius"] = F.tile_border_radius + "px")),
      1 == F.tile_enable_outline &&
        (o.outline = "1px solid " + F.tile_outline_color),
      1 == F.tile_enable_shadow)
    ) {
      var a = F.tile_shadow_h + "px ";
      (a += F.tile_shadow_v + "px "),
        (a += F.tile_shadow_blur + "px "),
        (a += F.tile_shadow_spread + "px "),
        (a += F.tile_shadow_color),
        (o["box-shadow"] = a);
    }
    e.css(o);
    var s = "";
  ...
  function b(e, t, i, n) {
    ...
    if (1 == Y.isTextpanelOutside) {
      ...
      if (
        ((i -= _),
        "top" == F.tile_textpanel_position && (d = _),
        1 == Y.hasImageContainer)
      ) {
        var c = a(e);
    ...
    if (0 == F.tile_enable_image_effect)
      D.scaleImageCoverParent(l, t, i),
        0 == Y.hasImageContainer && null !== d && D.placeElement(l, 0, d);
    else {
      var h = "nothing";
      n === !0 &&
        ...
        "effect" != h &&
          (D.setElementSize(o, t, i),
          null !== d && D.placeElement(o, 0, d),
          D.scaleImageCoverParent(u, t, i)),
        "image" != h &&
          (1 == Y.hasImageContainer
            ? D.scaleImageCoverParent(l, t, i)
            : "effect" == h
            ? (D.scaleImageCoverParent(l, t, i),
              null !== d && D.placeElement(l, 0, d))
            : D.cloneElementSizeAndPos(u, l, !1, null, d));
    }
  }
  function y(e, t, i, n) {
    var r = null;
  ...
  function I(e) {
    ...
    if (t && i) {
      ...
      I > E &&
        ...
        (w = m.width + I + v.width),
        (E = Math.floor((n.width - w) / 2))),
        D.placeElement(t, E, "middle", 0, _),
        D.placeElement(i, E + m.width + I, "middle", 0, _);
    } else
      t && D.placeElement(t, "center", "middle", 0, _),
        i && D.placeElement(i, "center", "middle", 0, _);
    t && t.show(), i && i.show();
  }
  function w(e, t) {
  ...
  function S(e, t) {
    if (
      ((t = jQuery(t)),
      F.tile_enable_image_effect && w(t, !0),
      1 == F.tile_enable_textpanel &&
  ...
  function P(e, t) {
    if (
      ((t = jQuery(t)),
      F.tile_enable_image_effect && w(t, !1),
      1 == F.tile_enable_textpanel &&
        0 == F.tile_textpanel_always_on &&
        E(t, !1),
  ...
  (this.loadTileImage = function (e) {
    ...
    (this.initEvents = function () {
      W.initEvents(),
        ...
        L.on(Y.eventSizeChange, j),
        N.delegate(".ug-tile .ug-button-play", "click", O),
        N.delegate(".ug-tile", "click", M),
        N.delegate(".ug-tile .ug-icon-link", "click", z);
    }),
    (this.destroy = function () {
      if (
    ...
    (this.run = function () {
      var e = W.getThumbs();
      F.tile_size_by == R.sizeby.GLOBAL_RATIO &&
        R.resizeAllTiles(F.tile_width, R.resizemode.WRAPPER_ONLY),
        1 == F.tile_enable_image_effect &&
          0 == F.tile_image_effect_reverse &&
          e.children(".ug-thumb-image").fadeTo(0, 0),
        W.setHtmlProperties(),
        1 == F.tile_visible_before_image &&
          (e.children(".ug-thumb-image").fadeTo(0, 0), W.loadThumbsImages());
    }),
    ...
    (this.getTileHeightByWidth = function (e, t) {
      ...
      return (
        t &&
          1 == Y.isTextpanelOutside &&
          F.tile_size_by == R.sizeby.IMAGE_RATIO &&
          (n += g(t)),
        n
      );
    }),
...
function UGSlider() {
  ...
  function X() {
    te.on(me.events.ITEM_IMAGE_UPDATED, Y),
      te.on(me.events.ITEM_CHANGE, N),
      ye && jQuery(ye).on(ye.events.BULLET_CLICK, L),
      1 == Se.slider_enable_arrows &&
        (we.addClassOnHover(de, "ug-arrow-hover"),
        we.addClassOnHover(ue, "ug-arrow-hover"),
        me.setNextButton(de),
        me.setPrevButton(ue)),
      0 == Se.slider_controls_always_on && re.hover(Q, D),
      ...
      ce && ce.initEvents(),
      Ie.initEvents(),
      jQuery(Ie).on(Ie.events.SHOW, F),
      jQuery(Ie).on(Ie.events.HIDE, B),
      V(ae),
      V(se),
      V(le),
      fe.on(pe.events.AFTER_PUT_IMAGE, U),
      re.delegate(".ug-item-wrapper img", "mouseenter", function (e) {
  ...
  (this.switchSlideNums = function (e) {
    ...
    (this.destroy = function () {
      fe.off(pe.events.AFTER_PUT_IMAGE),
        ...
        Ie.destroy(),
        re.undelegate(".ug-item-wrapper img", "mouseenter"),
        re.undelegate(".ug-item-wrapper img", "mouseleave");
    }),
    (this.________EXTERNAL_GENERAL___________ = function () {}),
    (this.init = function (t, i, n) {
      e(t, i, n);
...
function UGTextPanel() {
  function e(e, t) {
    ...
    if ((_ && (a = jQuery.trim(_.text())), "" != a)) {
      var s = i;
      d && (s += v.textpanel_padding_title_description),
        f.placeElement(_, 0, s);
...
function UniteGalleryMain() {
  ...
  function fillItemsArray(e) {
    ...
    for (var i = t.isMobileMode(), n = 0, r = 0; r < e.length; r++) {
      ...
      if (((u.type = l), "img" == a)) {
        ...
        d &&
          "" != d &&
          (o.attr("src", d), jQuery.removeData(o, "lazyload-src"));
        var _ = o.attr("src"),
          g = o.data("thumb");
        "undefined" != typeof g && "" != g
          ? ((u.urlThumb = g), (u.urlImage = _), o.attr("src", g))
          : ((u.urlThumb = _), (u.urlImage = o.data("image"))),
          (u.title = o.attr("alt")),
          (u.objThumbImage = o);
      } else {
        if ("image" == l) throw new Error("The item should not be image type");
        (u.urlThumb = o.data("thumb")),
          (u.title = o.data("title")),
          (u.objThumbImage = null),
          (u.urlImage = o.data("image"));
      }
      if (1 == i) {
        var c = o.data("thumb-mobile");
        "undefined" != typeof c &&
          "" != c &&
          ((u.urlThumb = c), "img" == a && o.attr("src", u.urlThumb));
        var h = o.data("image-mobile");
        "undefined" != typeof h && "" != h && (u.urlImage = h);
      }
      (u.link = s),
        (u.description = o.attr("title")),
        u.description || (u.description = o.data("description")),
      ...
      p &&
        ...
        ((u.thumbWidth = p),
        (u.thumbHeight = f),
        (u.thumbRatioByWidth = p / f),
        (u.thumbRatioByHeight = f / p)),
        (u.addHtml = null);
      ...
      switch (u.type) {
        case "youtube":
          if (((u.videoid = o.data("videoid")), m || v)) {
            ...
            m && (u.urlImage = b.preview),
              v &&
                ((u.urlThumb = b.thumb),
                "img" == a && o.attr("src", u.urlThumb));
          }
        ...
        case "vimeo":
          ...
          break;
        case "html5video":
          (u.videoogv = o.data("videoogv")),
            (u.videowebm = o.data("videowebm")),
            (u.videomp4 = o.data("videomp4")),
  ...
  (this.onItemBigImageLoaded = function (e, t) {
    ...
    (this.setFullScreenToggleButton = function (e) {
      e.data("ug-button", !0),
        g_functions.setButtonOnClick(e, t.toggleFullscreen),
        g_objGallery.on(t.events.ENTER_FULLSCREEN, function () {
    ...
    (this.ajaxRequest = function (e, t, i, n) {
      ...
      jQuery.ajax({
        ...
        success: function (e) {
          return e
            ? -1 == e || 0 === e
              ? (showErrorMessage("ajax error!!!"), !1)
              : "undefined" == typeof e.success
              ? (showErrorMessage("The 'success' param is a must!"), !1)
              : 0 == e.success
              ? (showErrorMessage(e.message), !1)
              : void n(e)
            : (showErrorMessage("Empty ajax response!", "Ajax Error"), !1);
        },
    ...
    (this.requestNewItems = function (e, i, n) {
      ...
      if (
        ...
        g_objGallery.trigger(t.events.GALLERY_BEFORE_REQUEST_ITEMS),
          t.ajaxRequest("front_get_cat_items", { catid: e }, !0, function (e) {
            var i = e.html;
            t.changeItems(i, n);
          });
    }),
...
function UGLightbox() {
  ...
  function B() {
    if (
      ...
      U.on(ie.events.ITEM_CHANGE, H),
      ne)
    ) {
      jQuery(ne).on(ne.events.TRANSITION_END, z),
        jQuery(ne).on(ne.events.CLICK, N);
      ...
      jQuery(e).on(e.events.PLAY_START, k),
        ...
        jQuery(ne).on(ne.events.IMAGE_MOUSEENTER, Q),
        jQuery(ne).on(ne.events.IMAGE_MOUSELEAVE, D);
    }
    jQuery(window).resize(function () {
      return 0 == se.isOpened
        ? !0
        : void re.whenContiniousEventOver("lightbox_resize", L, 100);
    }),
...
function UGCarousel() {
  function e(e, t) {
    (g_objects = e.getObjects()),
      (W = e),
      (N = jQuery(e)),
      (L = g_objects.g_objWrapper),
      (k = g_objects.g_arrItems),
      (U = jQuery.extend(U, t)),
      B.setFixedMode(),
      B.setApproveClickFunction(H),
      B.init(e, U),
      (Y = B.getObjThumbs()),
      (U = B.getOptions()),
  ...
  function t(e) {
    ...
    L.append(t),
      (R = L.children(".ug-carousel-wrapper")),
        ...
        ? (z(),
          ...
          jQuery.each(k, function (e, t) {
            t.objThumbWrapper.data("index", e),
              L.trigger(V.eventSizeChange, [t.objThumbWrapper, !0]),
              (t.objTileOriginal = t.objThumbWrapper.clone(!0, !0));
          }),
          m(!0),
          1 == U.carousel_autoplay && Q.startAutoplay())
        : (1 == U.carousel_autoplay && Q.pauseAutoplay(),
          w(0, !1),
          1 == U.carousel_autoplay && Q.startAutoplay()),
      P(),
      (V.isFirstTimeRun = !1);
  ...
  function j(e) {
    return 1 == V.touchActive
      ...
      : ((V.touchActive = !0),
        ...
        void F.storeEventData(e, V.storedEventID));
  }
  function C(e) {
    ...
    if (
      (1 == U.carousel_vertical_scroll_ondrag &&
        (t = F.handleScrollTop(V.storedEventID)),
      "vert" === t)
    )
      return !0;
    V.lastMousePos = o(e);
  ...
  function A(e) {
    return 0 == V.touchActive
      ? !0
      : ((V.touchActive = !1), T(), void Q.unpauseAutoplay());
  }
  function M(e) {
    return 0 == U.carousel_autoplay_pause_onhover
      ? !0
      : void (1 == V.isPlayMode && 0 == V.isPaused && Q.pauseAutoplay());
  }
  function O(e) {
    return 0 == U.carousel_autoplay_pause_onhover
      ? !0
      : void Q.unpauseAutoplay();
  }
  function z() {
    B.initEvents(),
  ...
  (this.startAutoplay = function () {
    ...
    (this.pauseAutoplay = function () {
      return 0 == V.isPlayMode
        ...
        : ((V.isPaused = !0),
          V.handle && clearInterval(V.handle),
          void D.trigger(Q.events.PAUSE_PLAY));
    }),
    (this.stopAutoplay = function () {
      return 0 == V.isPlayMode
        ...
        : ((V.isPaused = !1),
          (V.isPlayMode = !1),
          V.handle && clearInterval(V.handle),
          void D.trigger(Q.events.STOP_PLAY));
    }),
    (this.destroy = function () {
      V.handle && clearInterval(V.handle),
        D.off(Q.events.START_PLAY),
        D.off(Q.events.STOP_PLAY),
        R.unbind("mousedown"),
        R.unbind("touchstart"),
        jQuery("body").unbind("mousemove"),
        jQuery("body").unbind("touchmove"),
    ...
    (this.setPlayPauseButton = function (e) {
      F.setButtonMobileReady(e),
        ...
        D.on(Q.events.START_PLAY, function () {
...
!(function (e) {
  ...
  jQuery.extend(jQuery.easing, {
    ...
    easeOutElastic: function (e, t, i, n, r) {
      ...
      return (
        s * Math.pow(2, -10 * t) * Math.sin((2 * (t * r - o) * Math.PI) / a) +
        n +
        i
      );
    },
    ...
    easeInBack: function (e, t, i, n, r, o) {
      return (
        void 0 == o && (o = 1.70158), n * (t /= r) * t * ((o + 1) * t - o) + i
      );
    },
    easeOutBack: function (e, t, i, n, r, o) {
      return (
        void 0 == o && (o = 1.70158),
        n * ((t = t / r - 1) * t * ((o + 1) * t + o) + 1) + i
      );
    },
    easeInOutBack: function (e, t, i, n, r, o) {
      return (
        void 0 == o && (o = 1.70158),
        (t /= r / 2) < 1
          ? (n / 2) * t * t * (((o *= 1.525) + 1) * t - o) + i
          : (n / 2) * ((t -= 2) * t * (((o *= 1.525) + 1) * t + o) + 2) + i
      );
    },
